...
const SaveInfo = ({info}) => {
    ...
    return (
       ...
       <div className='md:grid md:grid-cols-2  items-center md:gap-x-60 '>
       <div>
   ...
   <Link   to={`../jobdetails/jobdetails/../${id} `}>  <button className='font-medium  px-3 py-1.5 md:px-6 md:py-2 m-2 text-lg  text-white btn'>View Details</button></Link>
